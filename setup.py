...
from alignak_checks_nrpe import __version__, __author__, __author_email__, __copyright__
from alignak_checks_nrpe import __license__, __url__, __checks_type__
from alignak_checks_nrpe import __name__ as __pkg_name__
